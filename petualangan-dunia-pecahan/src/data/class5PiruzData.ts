...
export const RAW_5PIRUZ: RawStudent5P[] = [
  // 1. Adam Hakimi — 27/27
  ...
  // === 7 MURID (STATUS: SELESAI 9/9, 24-27 BINTANG) ===
...
export const CLASS_5_PIRUZ_STUDENTS: StudentProfile[] = RAW_5PIRUZ.map((r) => {
